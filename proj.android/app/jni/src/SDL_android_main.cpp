...
extern "C" {
	...
	JNIEXPORT void JNICALL Java_org_tvp_kirikiri2n_KR2Activity_onMessageBoxOK(JNIEnv* env, jclass cls, jint nButton) {
		MsgBoxRet = nButton;
		MessageBoxCond.notify_one();
	}
    
	JNIEXPORT void JNICALL Java_org_tvp_kirikiri2n_KR2Activity_onMessageBoxText(JNIEnv* env, jclass cls, jstring text) {
...
#define KEYCODE_DEL 0x43
	...
	JNIEXPORT void JNICALL Java_org_tvp_kirikiri2n_KR2Activity_nativeOnLowMemory(JNIEnv* env, jclass cls)
	{
		Android_PushEvents([]() {
